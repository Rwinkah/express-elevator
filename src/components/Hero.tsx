    ...
    return (
        <section id="hero-section" className="pr bg-[#fafafa] h-full flex flex-col items-center m-0 p-0 mb-[5rem]">
            <div id="hero-headertext" className=" mt-[5rem] flex items-center flex-col">
                <h1 className="text-black text-wrap text-center font-semibold md:font-medium w-[80%] text-[5vw] mb-4">Rising to new heights with every express elevator ride</h1>
            ...
            {isTabletAbove ? 
                        ...
                        <img className="w-[25vw] h-auto" src={Hero1} />
        
                        <div className="m-0 p-0 flex flex-col gap-[6rem] items-center">
                            <img className="h-[250px]- w-[20vw]" src={Hero2} />
                            <button className="rounded-3xl text-white bg-expBlue w-[100%] shadow-2xl font-medium text-[20px]"> Get a free quote</button>
                        </div>
                        <img className="h-auto- w-[25vw]" src={Hero3} />
